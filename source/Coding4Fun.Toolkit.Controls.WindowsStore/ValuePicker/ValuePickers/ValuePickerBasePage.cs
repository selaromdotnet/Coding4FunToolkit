...
{
    public abstract class ValuePickerBasePage<T> : Page, IValuePickerPage<T> where T : struct
    {
        ...
        protected void InitializeValuePickerPage(LoopingSelector primarySelector, LoopingSelector secondarySelector, LoopingSelector tertiarySelector)
        {
			...
			// INCOMPLETE: REFACTOR THIS

			var bar = this.BottomAppBar.Content as CommandBar;
			//var btn = bar.PrimaryCommands.First() as AppBarButton;
			//btn.Click += OnDoneButtonClick;
			//var btn2 = bar.PrimaryCommands.Skip(1).First() as AppBarButton;
			//btn2.Click += OnCancelButtonClick;
        ...
        //                		break;
        //                	case "CANCEL":
								//button.Text = "Cancel";// Properties.Resources.CancelText;
        ...
        private void OnClosedStoryboardCompleted(object sender, object e)
        {
