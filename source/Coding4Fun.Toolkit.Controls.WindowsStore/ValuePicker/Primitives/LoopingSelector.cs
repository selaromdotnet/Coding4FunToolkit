...
#region Touch Events
		...
		private void AnimatePanel(Duration duration, EasingFunctionBase ease, double to)
		{
		...
		private void CreateVisuals()
		{
			...
			Storyboard.SetTargetProperty(_panelAnimation, new PropertyPath(propName).Path);
